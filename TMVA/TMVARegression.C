...
void BDT_Regression( TString myMethodList = "" ) 
{
   ...
   TString tmva_dir("/home/alejandro/TMVA-v4.2.0");
 ...
 //  dataloader->AddVariable( "Deltaphi34", "Deltaphi34", "units", 'S' );
  ...
  // You can add so-called "Spectator variables", which are not used in the MVA training, 
   ...
   TFile *input(0);
   TString fname = "data/BDT_trainning_LUT.root";
   ...
   //dataloader->SetWeightExpression( "phi1", "Regression" );
   ...
   dataloader->PrepareTrainingAndTestTree( mycut, 
                                        "nTrain_Regression=800:nTest_Regression=200:SplitMode=Random:NormMode=NumEvents:!V" );
   ...
   if (Use["BDTG"])
     factory->BookMethod( TMVA::Types::kBDT, "BDTG",
                           "!H:!V:NTrees=3000::BoostType=Grad:Shrinkage=0.1:UseBaggedBoost:BaggedSampleFraction=0.5:nCuts=30:MaxDepth=4" );
   // --------------------------------------------------------------------------------------------------
